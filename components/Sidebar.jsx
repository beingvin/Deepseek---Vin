      ...
      <div>
        ...
        <button
          ...
          className={`mt-8 flex items-center justify-center cursor-pointer ${
            expand
              ? "bg-primary hover:opacity-90 rounded-lg gap-2 p-2.5 w-max"
        ...
        >
          <Image
            ...
            alt=""
          />
          <div className="absolute w-max -top-12 -right-12 opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px3 py-2 rounded-lg shadow-lg pointer-events-none">
            New chat{" "}
        ...
        <div
          className={`flex items-center cursor-pointer group relative ${
            expand
              ...
              : "h-10 w-10 mx-auto hover:bg-gray-500/30"
          }`}
        >
          <Image
